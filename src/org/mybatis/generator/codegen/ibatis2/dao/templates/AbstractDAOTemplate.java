...
public abstract class AbstractDAOTemplate {
	 ...
	 *
	 * @param sqlMapNamespace the sql map namespace
	 ...
	 *
	 * @param constructorTemplate the new constructor template
	 */
	 ...
	 *
	 * @param deleteMethodTemplate the new delete method template
	 */
	 ...
	 *
	 * @param insertMethodTemplate the new insert method template
	 */
	 ...
	 *
	 * @param queryForListMethodTemplate the new query for list method template
	 */
	 ...
	 *
	 * @param queryForObjectMethodTemplate the new query for object method template
	 */
	 ...
	 *
	 * @param updateMethodTemplate the new update method template
	 */
	...
	/**
	 * This method is called in the constructor to configure the DAO template. Subclasses should implement the individual configureXXX methods to setup the relevant parts of the DAO template
	 * (super class, extra methods, etc.) that are relevant for this specific type of DAO.
	 */
	...
	/**
	 * Override this method to add checked exceptions to the throws clause of any generated DAO method. When overriding this method, call <code>addCheckedException(FullyQualifiedJavaType)</code>
	 * one or more times to add checked exception(s) to all generated DAO methods.
	 */
	protected void configureCheckedExceptions() {
	}
	
	/**
	 * Override this method to add fields to any generated DAO implementation class. When overriding this method, call <code>addField(Field)</code> one or more times to add field(s) to the
	 * generated DAO implementation class.
	 */
	protected void configureFields() {
	}
	
	/**
	 * Override this method to add imports to generated DAO implementation classes. When overriding this method, call <code>addImplementationImport(FullyQualifiedJavaType)</code> one or more times
	 * to add import(s) to generated DAO implementation classes.
	 */
	...
	/**
	 * Override this method to add methods to generated DAO implementation classes. When overriding this method, call <code>addMethod(Method)</code> one or more times to add method(s) to generated
	...
	/**
	 * Override this method to set the superclass for any generated DAO implementation class. When overriding this method call <code>setSuperClass(FullyQualifiedJavaType)</code> to set the
	 * superclass for generated DAO implementation classes.
	 */
	protected void configureSuperClass() {
	}
	
	/**
	 * Override this method to configure a constructor for generated DAO implementation classes. During code generation, we will build a new constructor using the visibility, parameters, body
	...
	/**
	 * Override this method to configure an insert method template. A method template is a string with three substitution markers that we will fill in when generating code. The substitution
	 * markers will be:
	 * <ul>
	...
	/**
	 * Override this method to configure a queryForList method template. A method template is a string with three substitution markers that we will fill in when generating code. The substitution
	 * markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	 * <li>{1} - The SqlMap statement id</li>
	...
	/**
	 * Override this method to configure a queryForObject method template. A method template is a string with three substitution markers that we will fill in when generating code. The substitution
	 * markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	 * <li>{1} - The SqlMap statement id</li>
	...
	/**
	 * Override this method to configure an update method template. A method template is a string with three substitution markers that we will fill in when generating code. The substitution
	 * markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	 * <li>{1} - The SqlMap statement id</li>
	...
	/**
	 * Override this method to configure a delete method template. A method template is a string with three substitution markers that we will fill in when generating code. The substitution markers
	 * will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	 * <li>{1} - The SqlMap statement id</li>
