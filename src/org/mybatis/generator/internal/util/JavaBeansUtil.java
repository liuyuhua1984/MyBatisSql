...
public class JavaBeansUtil {
	 ...
	 * JavaBeans rules:
	 * 
	 * eMail &gt; geteMail() firstName &gt; getFirstName() URL $gt; getURL() XAxis &gt; getXAxis() a &gt; getA() B &gt; invalid - this method assumes that this is not the case. Call
	 * getValidPropertyName first. Yaxis &gt; invalid - this method assumes that this is not the case. Call getValidPropertyName first.
	 *
	 ...
	 * JavaBeans rules:
	 * 
	 * eMail &gt; seteMail() firstName &gt; setFirstName() URL &gt; setURL() XAxis &gt; setXAxis() a &gt; setA() B &gt; invalid - this method assumes that this is not the case. Call
	 * getValidPropertyName first. Yaxis &gt; invalid - this method assumes that this is not the case. Call getValidPropertyName first.
	 *
	 * @param property the property
	 ...
	 * 
	 * 1. If the first character is lower case, then OK 2. If the first two characters are upper case, then OK 3. If the first character is upper case, and the second character is lower case, then
