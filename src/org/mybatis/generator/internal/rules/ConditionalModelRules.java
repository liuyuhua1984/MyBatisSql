...
public class ConditionalModelRules extends BaseRules {
	...
	/**
	 * Generate a base record if there are any base columns, or if there is only one primary key coulmn (in which case we will not generate a primary key class), or if there is only one BLOB
