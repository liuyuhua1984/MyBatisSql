...
public interface Rules {
	...
	/**
	 * Implements the rule for generating the update by primary key with BLOBs SQL Map element and DAO method. If the table has a primary key as well as other BLOB fields, and the
	 * updateByPrimaryKey statement is allowed, then generate the element and method.
	 * 
	 * @return true if the element and method should be generated
	 */
	...
	/**
	 * Implements the rule for generating the delete by primary key SQL Map element and DAO method. If the table has a primary key, and the deleteByPrimaryKey statement is allowed, then generate
	 ...
	 * 
	 * In iBATIS2, generate the element if the selectByExample, deleteByExample, updateByExample, or countByExample statements are allowed.
	 * 
	...
	/**
	 * Implements the rule for generating the select by example with BLOBs SQL Map element and DAO method. If the table has BLOB fields and the selectByExample statement is allowed, then generate
	 * the element and method.
	 * 
	 * @return true if the element and method should be generated
	 */
	...
	/**
	 * Implements the rule for determining whether to generate a primary key class. If you return false from this method, and the table has primary key columns, then the primary key columns will
	...
	/**
	 * Implements the rule for generating a Java client. This rule is only active when a javaClientGenerator configuration has been specified, but the table is designated as "modelOnly". Do not
