...
public interface JavaTypeResolver {
	...
	/**
	 * The generator will supply a list to this method. The implementation class may add strings to the list that will be treated as warning messages and displayed to the user. The concept of a
	 ...
	 * @return the calculated type, or null if an unsupported data type. If null is returned, we will set the type to Object and issue a warning unless the column is ignored or otherwise
	 *         overridden
	 */
	 ...
	 * 
	 * @param introspectedColumn the column whose Java type needs to be calculated
	 * @return the calculated type name, or null if an unsupported data type. If null is returned, we will set the type to OTHER and issue a warning unless the column is ignored or otherwise
	 *         overridden
	 */
