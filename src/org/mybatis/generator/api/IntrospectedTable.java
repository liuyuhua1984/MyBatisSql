...
/**
 * Base class for all code generator implementations. This class provides many of the housekeeping methods needed to implement a code generator, with only the actual code generation methods left
 * unimplemented.
 * 
 * @author Jeff Butler
 * 
...
public abstract class IntrospectedTable {
	...
	/**
	 * Should return true if an XML generator is required for this table. This method will be called during validation of the configuration, so it should not rely on database introspection. This
	 * method simply tells the validator if an XML configuration is normally required for this implementation.
	 *
	 * @return true, if successful
	 */
