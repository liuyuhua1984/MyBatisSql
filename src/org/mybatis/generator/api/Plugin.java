...
/**
 * This interface defines methods that will be called at different times during the code generation process. These methods can be used to extend or modify the generated code. Clients may implement
 ...
 * </ol>
 * 
 * Plugins are related to contexts - so each context will have its own set of plugins. If the same plugin is specified in multiple contexts, then each context will hold a unique instance of the
 * plugin.
 * <p>
...
public interface Plugin {
	...
	/**
	 * This method is called just before the getGeneratedXXXFiles methods are called on the introspected table. Plugins can implement this method to override any of the default attributes, or
	 * change the results of database introspection, before any code generation activities occur. Attributes are listed as static Strings with the prefix ATTR_ in IntrospectedTable.
	 * <p>
	 ...
	 * <p>
	 * <b>Warning:</b> Anything that is listed as an attribute should not be changed by one of the other plugin methods. For example, if you want to change the name of a generated example class,
	 * you should not simply change the Type in the <code>modelExampleClassGenerated()</code> method. If you do, the change will not be reflected in other generated artifacts.
	 *
	...
	/**
	 * This method is called after all the setXXX methods are called, but before any other method is called. This allows the plugin to determine whether it can run or not. For example, if the
	 * plugin requires certain properties to be set, and the properties are not set, then the plugin is invalid and will not run.
	 * 
	 ...
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the interface should be generated, false if the generated interface should be ignored. In the case of multiple plugins, the first plugin returning false will disable the
	 *         calling of further plugins.
	 */
	 ...
	 * @param topLevelClass the partially implemented client implementation class. You can add additional imported classes to the implementation class if necessary.
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the method should be generated, false if the generated method should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
	 *         of further plugins.
	 */
	 ...
	 * 
	 * @param method the generated countByExample method
	 * @param interfaze the partially implemented client interface. You can add additional imported classes to the interface if necessary.
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the method should be generated, false if the generated method should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
	 *         of further plugins.
	 */
	 ...
	 * @param introspectedColumn The class containing information about the column related to this field as introspected from the database
	 * @param introspectedTable The class containing information about the table as introspected from the database
	...
	/**
	 * This method is called after the primary key class is generated by the JavaModelGenerator. This method will only be called if the table rules call for generation of a primary key class. <br>
	 * <br>
	...
	/**
	 * This method is called after the base record class is generated by the JavaModelGenerator. This method will only be called if the table rules call for generation of a base record class. <br>
	 * <br>
	...
	/**
	 * This method is called after the record with BLOBs class is generated by the JavaModelGenerator. This method will only be called if the table rules call for generation of a record with BLOBs
	 * class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators may, or may not, call this method.
	 * 
	...
	/**
	 * This method is called after the example class is generated by the JavaModelGenerator. This method will only be called if the table rules call for generation of an example class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators may, or may not, call this method.
	 * 
	 ...
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the sqlMap should be generated, false if the generated sqlMap should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
	 *         of further plugins.
	 */
	 ...
	 * 
	 * @param document the generated document (note that this is the MyBatis generator's internal Document class - not the w3c XML Document class)
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the document should be generated, false if the generated document should be ignored. In the case of multiple plugins, the first plugin returning false will disable the
	 *         calling of further plugins. Also, if any plugin returns false, then the <tt>sqlMapGenerated</tt> method will not be called.
	 */
	 ...
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the element should be generated, false if the generated element should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
	 *         of further plugins.
	 */
	 ...
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the provider should be generated, false if the generated provider should be ignored. In the case of multiple plugins, the first plugin returning false will disable the
	 *         calling of further plugins.
	 */
	 ...
	 * @param topLevelClass the partially generated provider class You can add additional imported classes to the class if necessary.
	 * @param introspectedTable The class containing information about the table as introspected from the database
	 * @return true if the method should be generated, false if the generated method should be ignored. In the case of multiple plugins, the first plugin returning false will disable the calling
	 *         of further plugins.
	 */
