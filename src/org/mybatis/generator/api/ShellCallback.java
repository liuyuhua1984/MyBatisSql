...
public interface ShellCallback {
	...
	/**
	 * This method is called to ask the shell to resolve a project/package combination into a directory on the file system. This method is called repeatedly (once for each generated file), so it
	...
	/**
	 * This method is called if a newly generated Java file would overwrite an existing file. This method should return the merged source (formatted). The generator will write the merged source
	 * as-is to the file system.
	 * 
	 ...
	 * @throws ShellException if the file cannot be merged for some reason. If this exception is thrown, nothing will be saved and the existing file will remain undisturbed. The generator will add
	...
	/**
	 * After all files are saved to the file system, this method is called once for each unique project that was affected by the generation run. This method is useful if your IDE needs to be
	 * informed that file system objects have been created or updated. If you are running outside of an IDE, your implementation need not do anything in this method.
	 * 
