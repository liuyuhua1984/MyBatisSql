...
public class MyBatisGenerator {
	 ...
	 *                unsupported data type. In that case, the column will be ignored and generation will continue. You may specify <code>null</code> if you do not want warnings returned.
	...
	/**
	 * This is the main method for generating code. This method is long running, but progress can be provided and the method can be canceled through the ProgressCallback interface. This version of
	 ...
	 * @param callback an instance of the ProgressCallback interface, or <code>null</code> if you do not require progress information
	 * @param contextIds a set of Strings containing context ids to run. Only the contexts with an id specified in this list will be run. If the list is null or empty, than all contexts are run.
	 * @param fullyQualifiedTableNames a set of table names to generate. The elements of the set must be Strings that exactly match what's specified in the configuration. For example, if table
	 *                name = "foo" and schema = "bar", then the fully qualified table name is "foo.bar". If the Set is null or empty, then all tables in the configuration will be used for code
	 *                generation.
	 * @throws SQLException the SQL exception
	 * @throws IOException Signals that an I/O exception has occurred.
	 * @throws InterruptedException if the method is canceled through the ProgressCallback
	...
	/**
	 * Returns the list of generated Java files after a call to one of the generate methods. This is useful if you prefer to process the generated files yourself and do not want the generator to
	 * write them to disk.
	 * 
	...
	/**
	 * Returns the list of generated XML files after a call to one of the generate methods. This is useful if you prefer to process the generated files yourself and do not want the generator to
	 * write them to disk.
	 * 
