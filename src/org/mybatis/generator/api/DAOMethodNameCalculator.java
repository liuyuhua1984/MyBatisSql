...
public interface DAOMethodNameCalculator {
	...
	/**
	 * Calculates and returns a name for the select by example with BLOBs method. If the table contains BLOBs, then we will generate different select by example methods - one including BLOBs, one
	 * not including BLOBs.
	 *
	 * @param introspectedTable the introspected table
	 * @return the calculated name
