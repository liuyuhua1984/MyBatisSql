...
public class MyBatisGeneratorConfigurationParser {
	...
	/**
	 * This method resolve a property from one of the three sources: system properties, properties loaded from the <properties> configuration element, and "extra" properties that may be supplied
	 * by the Maven or Ant envireonments.
	 * 
