...
public class ColumnOverride extends PropertyHolder {
	...
	/**
	 * If true, the column is a GENERATED ALWAYS column which means that it should not be used in insert or update statements.
	 */
	 ...
	 *
	 * @param javaProperty the new java property
	 */
