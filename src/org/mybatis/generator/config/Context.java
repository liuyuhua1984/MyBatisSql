...
public class Context extends PropertyHolder {
	...
	/**
	 * Builds an XmlElement representation of this context. Note that the XML may not necessarily validate if the context is invalid. Call the <code>validate</code> method to check validity of
	 * this context.
	 * 
