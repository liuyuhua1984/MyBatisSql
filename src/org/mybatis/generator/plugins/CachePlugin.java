 ...
 * 
 * All properties correspond to properties of the MyBatis cache element and are passed "as is" to the corresponding properties of the generated cache element. All properties can be specified at the
 * table level, or on the plugin element. The property on the table element will override any property on the plugin element.
 * 
